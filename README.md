...
**AeroBeam** is a smart, standalone casting and presentation system designed for Raspberry Pi. It transforms any dumb projector or screen into a wireless, modern presentation hub.
...
- 🔄 **State Resiliency**: Accidentally refreshed your browser? Dropped Wi-Fi? AeroBeam tracks your active slide state and perfectly recovers on both the projector and the remote instantly.
- 🛜 **Smart Captive Portal (Fallback AP)**: If the Raspberry Pi can't find a known Wi-Fi network, it automatically spins up its own "AeroBeam-Setup" Wi-Fi hotspot. Connect to it to select the room's Wi-Fi, type the password, and let it seamlessly transition.
...
AeroBeam comes with a fully automated, one-click installer designed for fresh Raspberry Pi OS installations.
...
AeroBeam uses **Playwright** for complete End-to-End browser testing.
